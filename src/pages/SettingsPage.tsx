...
export default function SettingsPage() {
	...
	const currentLangLabel = getItemLabel(
		languagesDropdownTranslated,
		currentLang,
	);
	const currentThemeLabel = getItemLabel(
		themesDropdownTranslated,
		currentTheme,
	);
	return (
		<ConfigProvider
			...
			<div className="flex flex-col items-center p-8 gap-6 min-h-screen bg-white text-slate-900 dark:bg-slate-800 dark:text-slate-100 transition-colors">
				...
				<div className="flex flex-col gap-3 w-full max-w-xs">
					<NumberInputWithLabel
						...
						onBlur={() =>
							difficultyLvl === null && onDifficultyChange(defaultDifficulty)
						}
						placeholder="-"
					/>
					<DropdownWithLabel
